...
import municipalidad.obras.config.audit.AuditEventConverter;
import municipalidad.obras.domain.PersistentAuditEvent;
...
import static municipalidad.obras.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
